...
cwb-s-encode - Add structural annotation to an existing CWB corpus
...
Specifies that you want to work on I<corpus> (this is requried if you are adding to existing annotation with the B<-a> option).
The name of the corpus should be given in the all-lowercase format.
...
L<cwb-itoa>, L<cwb-lexdecode>, L<cwb-makeall>, L<cwb-scan-corpus>, L<cwb-s-decode>.
